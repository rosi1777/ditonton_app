...
class DatabaseHelper {
  ...
  Future<int> insertWatchlistTv(TvSeriesTable tvSerie) async {
    final db = await database;
    return await db!.insert(_tblWatchlistTv, tvSerie.toJson());
  }

  Future<int> removeWatchlistTv(TvSeriesTable tvSerie) async {
    final db = await database;
    return await db!.delete(
      _tblWatchlistTv,
      where: 'id = ?',
